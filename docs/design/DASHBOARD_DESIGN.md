...
│  [📍 Guadalajara]     │  │  │   • Actividad reciente      │ │  │
│                        │  │  │                             │ │  │
│  Usuario:             │  │  └─────────────────────────────┘ │  │
│  [Keila M.]           │  │                                   │  │
│  [Contact Center]     │  │                                   │  │
...
│                                                         │
│  Guadalajara     ████████████████████ $125,000         │
│  Ciudad Juárez   ████████████████ $98,500               │
│  Ciudad Obregón  ███████████████ $87,300                │
│  Loreto Héroes   ████████████ $78,650                   │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
├───────────┼──────────┼───────────┼──────────────────────┤
│ Guadala   │ 02-Feb   │ $12,450   │ [Revisar] [Aprobar]  │
│ Gdl       │ 02-Feb   │ $8,920    │ [Revisar] [Aprobar]  │
│ C. Juárez │ 01-Feb   │ $15,300   │ [Revisar] [Aprobar]  │
└───────────┴──────────┴───────────┴──────────────────────┘
```
...
│                                                             │
│  Sucursal: [📍 Guadalajara ▼]     [🔔 5]  [👤 Keila M. ▼] │
└─────────────────────────────────────────────────────────────┘
```
...
- "Antonio aprobó corte de Guadalajara"
